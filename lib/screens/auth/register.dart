...
import 'package:nextgen/screens/auth/otp_verify.dart';
...
mobile(){
  ...
  mobileOtp(emailController.text,).then((value) {
    print(value);
    if(value[0] !="Mobile number did not exists"){
      setState(() {
        error = value;
        iserror= true;
        isLoading = false;
 ...
 return Navigator.push(context, MaterialPageRoute(builder: (context){
    return OTPScreen(mobile: emailController.text, otp: value[1].toString(),);
  }));
    }
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      //Name ============>
                      CommonHelper().labelCommon("Mobile Number"),
                      ...
                      CommonHelper().buttonOrange("Register", () {
                    mobile();
                      }),
                      //       .buttonOrange("Login", () {
