...
class DueListSingleScreen extends StatelessWidget {
  final DueList data;

  const DueListSingleScreen({required this.data, Key? key}) : super(key: key);
                    ...
                    Container(
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              child: CommonHelper().bRow('Due', data.dueAmount,
                                  lastBorder: false,
